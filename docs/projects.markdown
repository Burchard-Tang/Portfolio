...
<h1>2026</h1>
<ul>
<li><a href="#CPS06">Crochet Pattern Simulator (MATLAB)</a></li>
</ul>
<h1>2025</h1>
<ul>
...
<div class="target-anchor" id="CPS06"></div>
<div class="project-card">
    <p class="project-title">Crochet Pattern Simulator (MATLAB)</p>
    <p class="project-date">May - June 2026</p>
    <hr class="solid">
    <p class="project-description">
A crochet pattern simulator built to convert sets of stitches in text file format to 3D forms. Applying a nodal system where each stitch calculates and adjusts its position with connected nodes. Physics between nodes was modeled based off hands-on experience with the tension and deformation of crocheted material.</p>
    <img class="project-img" src="/Portfolio/images/Projects/CrochetPlots.png" alt="Simulated plots of crochet patterns generated by the program">
    <p class="project-img-caption">Simulated plots of crochet patterns generated by the program.</p>
</div>
